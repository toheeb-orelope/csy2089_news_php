...
class DatabaseTable
{
    ...
    According to Toheeb (2024), PHP best practice code involved best way to write php code, web structure, and DatabaseTable manipulation.
    */
    ...
    //This function is used to query the DatabaseTable to fetch a single item
    ...
    //This function is used to query the DatabaseTable to fetch all items in the DatabaseTable
    function genFindAll()
    {
    ...
    //This function is used to delete item from the DatabaseTable
    ...
    //This function is used to INTER item from the DatabaseTable
    ...
    //This functions is use to query update from DatabaseTable
    ...
    function letInsertImage($file, $dbInstance, $uploadDir = '../images/')
    {
        try {
            ...
            // Insert image metadata into the DatabaseTable
